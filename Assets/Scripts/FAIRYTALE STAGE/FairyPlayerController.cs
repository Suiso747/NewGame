...
public class FairyPlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            audioSource.clip = groundedSE; // 着地
            audioSource.time = 0.1f;  // SEの再生時間微調整

            //Music.QuantizePlay(audioSource, 7);
            audioSource.Play();
    ...
    void FixedUpdate()
    {
        ...
        if (goJump)
        {
            ...
            audioSource.Play();
            //Music.QuantizePlay(audioSource);
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            Debug.Log("Reverse");
            collision.gameObject.GetComponent<MagicReverse>().Reverse();
        ...
        {
            Debug.Log("SpeedUp");
            collision.gameObject.GetComponent<MagicSpeedUp>().SpeedUp();
